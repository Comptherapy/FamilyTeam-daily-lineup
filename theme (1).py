...
.st-key-scoreboard_panel h1 {{ color: var(--cream) !important; }}
...
def title_with_icon(title_text):
    """Renders the app title with a basketball icon beside it (light text, for the scoreboard panel)."""
    st.markdown(
        f'<div style="display:flex;align-items:center;gap:12px;">'
        f'{basketball_icon(42, stroke="#FFFBF3")}'
